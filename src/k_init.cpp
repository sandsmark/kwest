...
void os_fatal(const char *s)
{
  ...
  KMessageBox::sorry(global_kwestview, qs);
  frotz_fatal_error = 1;
}
...
void os_init_screen()
{
  ...
  */
  ...
  h_screen_width  = global_kwestview->width();
  h_screen_height = global_kwestview->height();
...
{
  global_kwestview->flushLineBuffer();
  global_kwestview->repaint();
}
